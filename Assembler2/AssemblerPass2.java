...
import Assembler2.Tuple;
import Assembler2.SymTuple;
import Assembler2.LitTuple;
...
public class AssemblerPass2 {
	...
	static void initiallizeTables() throws Exception{
		...
		String s;
		BufferedReader br;
		br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\SANKET\\Desktop\\symtable.txt")));
		while((s = br.readLine()) != null) {
			StringTokenizer st = new StringTokenizer(s, "\t", false);
			symtable.add(new SymTuple(st.nextToken(), st.nextToken(), ""));
		}
		br.close();
		br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\SANKET\\Desktop\\littable.txt")));
		while((s = br.readLine()) != null) {
			StringTokenizer st = new StringTokenizer(s, "\t", false);
	...
	static void pass2() throws Exception{
		BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\SANKET\\Desktop\\output_pass1.txt")));
		out_pass2 = new PrintWriter(new FileWriter("C:\\Users\\SANKET\\Desktop\\output_pass2.txt"), true);
		String s;
