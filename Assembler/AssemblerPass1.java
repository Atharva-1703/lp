...
import Assembler.LitTuple;
import Assembler.SymTuple;
import Assembler.Tuple;
...
static void Pass1() throws Exception {
	BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\SANKET\\Desktop\\inputAssembler.txt")));
	out_pass1 = new PrintWriter(new FileWriter("C:\\Users\\SANKET\\Desktop\\output_pass1.txt"), true);
	PrintWriter out_symtable = new PrintWriter(new FileWriter("C:\\\\Users\\\\SANKET\\\\Desktop\\\\symtable.txt"), true);
	PrintWriter out_littable = new PrintWriter(new FileWriter("C:\\Users\\SANKET\\Desktop\\littable.txt"), true);
	String s;
	lc=0;
...
static void initializeTables() throws Exception {
	...
	br = new BufferedReader(new InputStreamReader(new
			FileInputStream("C:\\Users\\SANKET\\Desktop\\mot.txt")));
